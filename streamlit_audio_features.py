...
Full_data_10 = Sort_DF.head(10)

ui_df = Sort_DF.drop(['Item', 'Id', 'type', 'id', 'uri', 'track_href', 'analysis_url', 'duration_ms', 'time_signature'], axis=1)

#print(ui_df)
#st.write(ui_df)

chart_df = ui_df[['Artist', 'Album Name', 'Song Name', 'Release Date', 'Popularity', f'{Name_of_Feat}']]

import matplotlib.pyplot as plt

#st.pyplot(fig='scatter')

import numpy as np
import altair as alt

#arr = np.random.normal(1, 1, size=100)
#plt.scatter(x=chart_df['Popularity'], y=chart_df[f'{Name_of_Feat}'])
#st.pyplot()
